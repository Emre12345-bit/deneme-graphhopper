...
```bash
# Temel rota
curl "http://localhost:8989/route?point=37.989355,32.523069&point=37.860192,32.547872&profile=car&locale=tr"

# EDS kaçınma ile
curl "http://localhost:8989/route?point=37.989355,32.523069&point=37.860192,32.547872&profile=car&avoid_eds_roads=true&locale=tr"

# Custom areas kaçınma ile
curl "http://localhost:8989/route?point=37.989355,32.523069&point=37.860192,32.547872&profile=car&avoid_custom_areas=true&locale=tr"
```

## 📖 Detaylı Dokümantasyon

Detaylı kurulum ve kullanım kılavuzu için [README-TRAFFIC.md](README-TRAFFIC.md) dosyasını inceleyin.

---

**Orijinal GraphHopper:** GraphHopper is a fast and memory-efficient routing engine released under Apache License 2.0.
